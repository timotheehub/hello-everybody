...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE1 = "CREATE TABLE table_profile (jid TEXT NOT NULL, firstName TEXT NOT NULL, lastName TEXT, age INT, relationshipStatus TEXT, sexStatus TEXT)";
