...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE1 = "CREATE TABLE table_profile (ID INTEGER PRIMARY KEY AUTOINCREMENT, firstName TEXT NOT NULL, lastName TEXT, relationshipStatus TEXT NOT NULL, Age INT, SexStatus TEXT)";
